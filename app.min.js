...
controller:"oChartsCtrl",controllerAs:"C3"});$routeProvider.when("/details",{templateUrl:"company02/views/details.html",controller:"oDetailsCtrl",controllerAs:"C4"});$routeProvider.otherwise({templateUrl:"views/login.html",controller:"oMCtrl as C0",controllerAs:"C0"})}]);
