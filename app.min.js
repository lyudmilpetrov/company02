...
oM.config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){$locationProvider.html5Mode({enabled:true,requireBase:false});$routeProvider.when("/login",{templateUrl:"views/login.html",controller:"oMCtrl",controllerAs:"C0"});$routeProvider.when("/start",{templateUrl:"views/start.html",controller:"oStartCtrl",controllerAs:"C1"});$routeProvider.when("/maps",{templateUrl:"views/maps.html",controller:"oMapsCtrl",controllerAs:"C2"});$routeProvider.when("/charts",{templateUrl:"views/charts.html",
